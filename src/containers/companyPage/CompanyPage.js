...
const CompanyPage = ({ match }) => {
  ...
  useEffect(() => {
    fetch(
      `https://sandbox.iexapis.com/stable/stock/${match.params.symbol}/batch?types=income,balance-sheet,cash-flow&period=annual&token=${process.env.REACT_APP_IEX_TOKEN}`
    )
